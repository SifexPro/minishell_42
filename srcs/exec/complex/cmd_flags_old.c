...
{
	int		cmd_count;//// remove
	int		pipe_count;//// remove
	char	*infile;//// remove
	char	*outfile;//// remove
	char	*heredoc;//// remove
	bool	has_infile;//// remove
	bool	has_outfile;//// remove
	bool	has_append;//// remove
	bool	has_heredoc;//// remove
	int		total_redir;
	pid_t	*pid;
	int		*fd_in;
	int		*fd_out;
	int 	pipe_index;//// -1 when finished/none
	int		pipe_nb;//// ?
	t_pipe	**pipe;
	t_exec	**cmd;//// remove
